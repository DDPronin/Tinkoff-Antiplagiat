...
with open(score_path, 'w', encoding='utf-8') as file:
    for pair in path_pairs:
        try:
            ...
            # в некоторых файлах ключевые слова являются именами переменных
            # + иногда ast выдает syntax error на входный файлах -
            # обработаем это исключение
            file.write('syntax error in input py file' + '\n')
